...
// Основные настройки:
$recipients = ['chikibobiki@gmail.com']; // Получатели писем
...
// Настройки SMTP:
$smtp_host     = 'smtp.timeweb.ru'; // SMPT-адрес сервера
$smtp_port     = 465; // TCP-порт
$smtp_secure   = 'ssl'; // SMTP TLS/SSL
$smtp_auth     = true; // SMPT-аутентификация
$smtp_username = 'info@dwds.ru'; // Почтовый ящик, с которого будут отправляться письма
$smtp_password = 'FaA911faa'; // Пароль почтового ящика, с которого будут отправляться письма
